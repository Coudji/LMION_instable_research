...
function GarageProfiles.getByEntityId(entityId)
    ensureBuilt()
    return profilesByEntityId[entityId]
end

function GarageProfiles.getByGameScript(gameScript)
    local entityId = getGameScriptEntityId(gameScript)
    return entityId and GarageProfiles.getByEntityId(entityId) or nil
end
