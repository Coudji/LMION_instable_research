return {
    ...
    defaults = {
        doorType = "Sliding", materialType = "Glass_Solid", doorSound = "SlidingGlassDoor", thumpSound = "ZombieThumpWindow",
        engineMaterials = { "MetalPlates", "MetalBars", "Glass" },
        durability = { worldHealth = 250, health = 250, skillBaseHealth = 0 },
        construction = {
            category = "Welding", variantGroup = "SlidingDoors.Glass", timedAction = "BuildWallMetal",
            skill = { MetalWelding = 3 }, time = 100, xp = 15, tools = { { tag = "base:weldingmask" } },
            materials = {
        ...
        pickup = {
            ...
            breakChance = 0, packages = { count = 1, weight = 20, itemTemplate = "Base.LMION_{entityName}" },
        },
        replacement = {
