return {
    ...
    defaults = {
        ...
        construction = {
            category = "Carpentry", variantGroup = "Doors.Wood.FullGlass", timedAction = "BuildWallHammer",
            skill = { Woodwork = 7 }, time = 170, xp = 40,
            tools = { { tag = "base:hammer", flags = { "Prop1", "MayDegradeVeryLight" } }, { tag = "base:screwdriver" } },
            materials = {
                { item = "Base.Plank", amount = 2 }, { item = "Base.Nails", amount = 2 },
                { item = "Base.Hinge", amount = 2 }, { item = "Base.Screws", amount = 4 },
                { item = "Base.Doorknob", amount = 1 }, { item = "Base.GlassPanel", amount = 3 },
            },
        },
        pickup = {
